...
!(function (t, e) {
    ...
    function _(t, e, n) {
        ...
        for (var r in e)
            y(e[r])
                ? (i[r] = e[r](t, i, n))
                : v('Extension must be a function');
    ...
    function S(t, n) {
        ...
        if (n.hasOwnProperty('classes')) {
            ...
            ['direction', 'type', 'slide', 'arrow', 'nav'].forEach(
                function (r) {
                ...
                o(t, [
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            g(t)
                                ? (this._o = t)
                                : v('Options must be an `object` instance.');
                        },
                    },
                    {
                        key: 'index',
            ...
            Html: function (t, e, n) {
                var i = {
                    ...
                    collectSlides: function () {
                        this.slides = P(this.wrapper.children).filter(
                            function (e) {
                ...
                var i = new R(),
                    ...
                    c = {
                        ...
                        unbindSwipeStart: function () {
                            i.off(V[0], e.Html.wrapper, a),
                                i.off(V[1], e.Html.wrapper, a);
                        },
